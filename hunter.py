...
printf "\e[1;77m  _   _             _     __        ___ _   _       _   _       _                     \e[0m\n"
printf "\e[1;77m | | | |_   _ _ __ | |_   \ \      / (_) |_| |__   | | | | ___ | |_ __ ___   ___  ___ \e[0m\n"
printf "\e[1;77m | |_| | | | | '_ \| __|   \ \ /\ / /| | __| '_ \  | |_| |/ _ \| | '_ \` _ \ / _ \/ __|\e[0m\n"
printf "\e[1;77m |  _  | |_| | | | | |_     \ V  V / | | |_| | | | |  _  | (_) | | | | | | |  __/\__ \ \e[0m\n"
printf "\e[1;77m |_| |_|\__,_|_| |_|\__|     \_/\_/  |_|\__|_| |_| |_| |_|\___/|_|_| |_| |_|\___||___/\e[0m\n"
printf "\n"
printf "\e[1;93m          .:.:;..\e[0m\e[1;77m Social Network User Finder v2.0 \e[0m\e[1;93m..;:.:.\e[0m\n"
printf "\e[1;96m                    Track users across 80+ platforms\e[0m\n"
printf "\n"
...
check1=$(curl -s -i "https://tracky.com/user/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'profile:username' ; echo $?)
